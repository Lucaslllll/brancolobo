...
from principal.models import Product, Ingredients, Contact, Initial
from principal.models import How_Use, Video_Description, How_Use_Text
...
def index(request):
	...
	data = {'doubts': doubts, 'clients':clients, 'Photo_Product':Photo_Product,
	 		...
	 		'how_text': how_text, 'ingredients': ingredients}
